...
# Relative Imports zur Infrastruktur
...
class SettingsManager:
    ...
    def __init__(self, relative_path):
        # Stellt den absoluten Pfad zur Einstellungsdatei sicher
    ...
    def load_settings(self):
        ...
        try:
            ...
            # Für Overlays wird eine FileNotFoundError ausgelöst, wenn die Datei nicht existiert.
            server_log.warning(f"Einstellungsdatei nicht gefunden: {self.absolute_path}")
            # Erneutes Raise, damit der Service Layer den Fehler behandeln kann.
            raise
    ...
    def save_settings(self, settings_data):
        ...
        try:
            ...
            with open(self.absolute_path, 'w', encoding='utf-8') as f:
                # Nutzt indent=4 und ensure_ascii=False für lesbare, deutsche Umlaute
